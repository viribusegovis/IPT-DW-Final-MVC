...
{
    /// <inheritdoc />
    public partial class _09072024_1348 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizzesTags", x => new { x.Quiz_Id, x.Tag_Id });
                    table.ForeignKey(
                        name: "FK_QuizzesTags_Quizzes_Quiz_Id",
                        column: x => x.Quiz_Id,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizzesTags_Tags_Tag_Id",
                        column: x => x.Tag_Id,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
